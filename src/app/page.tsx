...
const FEATURES = [
  {
    ...
    description: "Funds arrive in seconds, not days. Our real-time settlement engine moves your money at the speed of the internet.",
    stat: "<30s",
  ...
  },
  {
    ...
    description: "256-bit encryption, SOC 2 Type II certified, and licensed in all operating jurisdictions.",
    stat: "SOC 2",
    statLabel: "certified",
  },
  {
    ...
    title: "Lowest Fees",
    description: "Starting at just 0.25% per transfer. No hidden charges, no surprises -- transparent, honest pricing.",
    stat: "0.25%",
...
const STEPS = [
  {
    ...
    description: "Sign up in under 2 minutes with just your email and phone number. Instantly verified.",
    icon: (
  ...
  },
  {
    ...
    description: "Enter your recipient's details and choose their preferred payout method from 50+ options.",
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "Lock in your exchange rate, confirm the amount, and transfer instantly. It's that simple.",
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
const TIERS = [
  ...
  },
  {
    ...
    price: "$19",
    period: "/mo",
    description: "For freelancers and small businesses with regular international transfers.",
    features: ["Up to $50,000/month", "0.25% transfer fee", "Mid-market rates", "Priority support", "Unlimited transfers", "Multi-currency wallet"],
    ...
    <div className="relative min-h-screen bg-[#08080c] text-zinc-100 overflow-x-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6">
          <nav className="glass-strong mt-4 flex h-14 items-center justify-between rounded-2xl px-6">
            <a href="#" className="text-lg font-heading font-bold tracking-tight">
              <span className="gradient-text">Xfer</span><span className="text-white">Credit</span>
            </a>
            ...
            <div className="flex items-center gap-4">
              <a href="#pricing" className="hidden sm:inline-flex text-[13px] text-zinc-400 font-medium hover:text-white transition-colors duration-200">
                Log in
              </a>
              <a
                href="#pricing"
      ...
      <section className="relative pt-36 pb-24 md:pt-52 md:pb-40 hero-glow">
        ...
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          {/* Status badge */}
          <div className="animate-fade-in-up mb-8 inline-flex items-center gap-2.5 rounded-full glass px-5 py-2 text-[13px] text-zinc-400">
          ...
          <h1 className="animate-fade-in-up-delay-1 font-heading text-5xl font-extrabold leading-[1.08] tracking-tight sm:text-6xl md:text-7xl lg:text-8xl">
            Move Money<br className="hidden sm:block" />
            Across Borders{" "}
            <span className="gradient-text">Instantly</span>
          </h1>

          <p className="animate-fade-in-up-delay-2 mx-auto mt-7 max-w-2xl text-lg leading-relaxed text-zinc-400 md:text-xl">
          ...
          {/* Social proof */}
          <div className="animate-fade-in-up-delay-4 mt-20 flex flex-wrap items-center justify-center gap-x-8 gap-y-4">
      ...
      <section id="features" className="relative py-28 md:py-36">
        ...
        <div className="relative mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-2xl text-center">
            <p className="text-[13px] font-semibold uppercase tracking-[0.2em] text-brand-light">Features</p>
          ...
          <div className="mt-20 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {FEATURES.map((f) => (
              <div key={f.title} className="group glass-card rounded-2xl p-7">
                <div className="mb-5 inline-flex rounded-xl bg-brand/10 p-3 text-brand-light transition-colors duration-300 group-hover:bg-brand/20 group-hover:text-white">
                  {f.icon}
                </div>
                <h3 className="font-heading text-lg font-semibold">{f.title}</h3>
                <p className="mt-2.5 text-[14px] leading-relaxed text-zinc-400">{f.description}</p>
                <div className="mt-5 flex items-baseline gap-1.5 border-t border-white/5 pt-5">
                  <span className="text-xl font-bold gradient-text">{f.stat}</span>
                  <span className="text-[12px] text-zinc-500">{f.statLabel}</span>
                </div>
              </div>
            ))}
          </div>
      ...
      <section id="how-it-works" className="relative py-28 md:py-36">
        ...
        <div className="relative mx-auto max-w-5xl px-6">
          <div className="mx-auto max-w-2xl text-center">
            <p className="text-[13px] font-semibold uppercase tracking-[0.2em] text-brand-light">How It Works</p>
            <h2 className="mt-4 font-heading text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl">
          ...
          <div className="mt-20 grid gap-6 md:grid-cols-3">
            {STEPS.map((s, idx) => (
              <div key={s.step} className="group relative glass-card rounded-2xl p-8">
                {/* Connector line */}
                {idx < STEPS.length - 1 && (
                ...
                <div className="flex items-center gap-4 mb-5">
                  ...
                  <span className="text-[13px] font-bold text-zinc-600 tracking-wider">STEP {s.step}</span>
                </div>
                <h3 className="font-heading text-xl font-semibold">{s.title}</h3>
                <p className="mt-3 text-[14px] text-zinc-400 leading-relaxed">{s.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="relative">
        ...
        <div className="glass-strong">
          <div className="mx-auto grid max-w-7xl grid-cols-2 md:grid-cols-4">
            {STATS.map((stat, idx) => (
              <div key={stat.label} className={`flex flex-col items-center justify-center py-12 px-6 text-center ${idx < STATS.length - 1 ? "md:border-r md:border-white/5" : ""}`}>
                <span className="font-heading text-3xl font-bold gradient-text md:text-4xl">{stat.value}</span>
                <span className="mt-2 text-[13px] text-zinc-500 tracking-wide">{stat.label}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="pricing" className="relative py-28 md:py-36">
        ...
        <div className="relative mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-2xl text-center">
            <p className="text-[13px] font-semibold uppercase tracking-[0.2em] text-brand-light">Pricing</p>
            <h2 className="mt-4 font-heading text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl">
            ...
            {TIERS.map((tier) => (
              ...
              >
                ...
                <div className="mt-5 flex items-baseline gap-1">
                  ...
                  {tier.period && <span className="text-[14px] text-zinc-500">{tier.period}</span>}
                </div>
                <p className="mt-4 text-[14px] text-zinc-400 leading-relaxed">{tier.description}</p>
      ...
      <section id="testimonials" className="relative py-28 md:py-36">
        ...
        <div className="relative mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-2xl text-center">
            <p className="text-[13px] font-semibold uppercase tracking-[0.2em] text-brand-light">Testimonials</p>
            <h2 className="mt-4 font-heading text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl">
      ...
      <footer className="glass-strong">
        <div className="mx-auto max-w-7xl px-6 py-16">
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              <h4 className="text-[12px] font-semibold uppercase tracking-[0.15em] text-zinc-400">Product</h4>
              <ul className="mt-4 space-y-3 text-[13px] text-zinc-500">
                <li><a href="#" className="hover:text-white transition-colors duration-200">Send Money</a></li>
                <li><a href="#" className="hover:text-white transition-colors duration-200">Business Payments</a></li>
                <li><a href="#" className="hover:text-white transition-colors duration-200">API &amp; Integrations</a></li>
                <li><a href="#" className="hover:text-white transition-colors duration-200">Pricing</a></li>
              </ul>
            </div>
            <div>
              <h4 className="text-[12px] font-semibold uppercase tracking-[0.15em] text-zinc-400">Company</h4>
              <ul className="mt-4 space-y-3 text-[13px] text-zinc-500">
            ...
            <div>
              <h4 className="text-[12px] font-semibold uppercase tracking-[0.15em] text-zinc-400">Legal</h4>
              <ul className="mt-4 space-y-3 text-[13px] text-zinc-500">
